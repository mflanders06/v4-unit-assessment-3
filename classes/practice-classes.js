...
const myChar = new Character('Derrick', 'Ranger');
//console.log(myChar.getInfo());
...
const barkeep = new NPC('Tony', 'Bartender', 'SouthTown', 'Welcome to my humble establishment!');

//console.log(barkeep.dialogue());
...
//const aang = new Player('Aang', 'airbender', 'Air Nation', 'Yip yip!', 100, 100);
...
fireSpitter.addSuperPower('spitting plasma');
fireSpitter.addSuperPower('spitting');
